...
import com.example.ciclodevida.databinding.BienvenidaBinding
import com.example.ciclodevida.databinding.PausaBinding
        ...
        if (parar) {
            ...
            boton.setOnClickListener {
                ...
                /* val intent = Intent (this, Control::class.java)
                 ...
                 intent.putExtra ("usuario", login.etUsuario.text.toString())
                 intent.putExtra("password", login.etPassword.text.toString())
